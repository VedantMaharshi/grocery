...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            <Link to={'/'}>
                <h1 className="text-2xl font-bold text-indigo-600">GoGrocery</h1>
            </Link>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={() => navigate('/cart')} className="relative cursor-pointer">
                   <img src={assets.cart_icon} alt="" className="w-6.5 h-6.5" />
                ...
                {user ? (
                    <>
                     <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow-md rounded-md border border-gray-300 py-2 z-40 text-sm w-30'>
