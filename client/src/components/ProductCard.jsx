            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                       ...
                       alt="rating" className='w-3 md:w-3.5'/>
                    ))}  <p>(4)</p>
                </div>
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-indigo-500" onClick={(e)=>e.stopPropagation()}>
                        {!cartItems[product._id]?(
                            ...
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-indigo-500/25 rounded select-none cursor-pointer">
